...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(40, 31, 1851, 991))
        ...
        self.doctors_table = QtWidgets.QListWidget(parent=self.widget)
        font = QtGui.QFont()
        ...
        self.surnames_table = QtWidgets.QListWidget(parent=self.widget)
        font = QtGui.QFont()
        font.setPointSize(14)
        ...
        self.shedule = QtWidgets.QTableWidget(parent=self.widget)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Specialization"))
        self.label_2.setText(_translate("MainWindow", "Doctors names "))
